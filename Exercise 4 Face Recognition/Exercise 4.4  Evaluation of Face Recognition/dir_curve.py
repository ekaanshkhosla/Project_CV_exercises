...
evaluation = OpenSetEvaluation(classifier=classifier, false_alarm_rate_range=false_alarm_rate_range)
...
#print(max(results['identification_rates']))

# Plot the DIR curve.
plt.semilogx(false_alarm_rate_range, results['identification_rates'], markeredgewidth=1,linewidth=3, linestyle="--", color="blue")
plt.grid(True)
